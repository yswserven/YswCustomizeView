...
public class RotateAnimation extends Animation {
     ...
     */
    private InterpolatedTimeListeners listener;
    ...
    public void setInterpolatedTimeListeners(InterpolatedTimeListeners listener) {
     ...
     * 动画进度监听器。
     */
    public static interface InterpolatedTimeListeners {
