package com.yswcustomizeview.mAnimation;
...
public class ClipPath extends View {
    ...
    public ClipPath(Context context) {
        super(context);
        mContext = context;
    }

    public ClipPath(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public ClipPath(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mLG = new LinearGradient(0f, 0f, mWidth, 2 * mRadius, Color.parseColor("#7286F6"), Color.parseColor("#518DEF"), Shader.TileMode.REPEAT);
     ...
     */
    public void drawBankground(boolean isBottom) {
        Path one = new Path();
        ...
        if (isBottom) {
            ...
            mPaint.setAntiAlias(true);
            mPaint.setStyle(Paint.Style.FILL);
            mPaint.setColor(Color.parseColor("#e54c3c"));
            ...
            mPaint.setAntiAlias(true);
            mPaint.setStyle(Paint.Style.FILL);
            mPaint.setColor(Color.parseColor("#FFBBFF"));
            one.op(two, Path.Op.UNION);
            one.op(three, Path.Op.UNION);
            one.op(four, Path.Op.UNION);
            one.op(five, Path.Op.UNION);
